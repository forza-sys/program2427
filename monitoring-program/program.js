...
(function() {
  ...
  function renderKPI(filteredData) {
    ...
    if (elSelesaiPct) {
        if (munasTotal > 0) {
            elSelesaiPct.textContent = Math.round((munasSelesai / munasTotal) * 100) + '% dari total Mandat Munas';
        } else {
    ...
    if (elProcessPct) {
        if (munasTotal > 0) {
            elProcessPct.textContent = Math.round((munasProcess / munasTotal) * 100) + '% dari total Mandat Munas';
        } else {
    ...
    if (elRencanaPct) {
        if (munasTotal > 0) {
            elRencanaPct.textContent = Math.round((munasRencana / munasTotal) * 100) + '% dari total Mandat Munas';
        } else {
